...
public class VehicleSoldListScreen extends LargeView {
	...
	public VehicleSoldListScreen() {
		this.setTitle(this.getTitle() + "Lista de ve�culos vendidos");
	...
	public void addLabels() {
		...
		userLoggedMessage.setText("Ol�, " + UserService.USER_LOGGED.getName());
		...
		edit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (vehiclesTable.getSelectedRow() >= 0) {
					...
					JOptionPane.showMessageDialog(null, "Nenhum ve�culo est� selecionado.");
				}
			}
		...
		delete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (vehiclesTable.getSelectedRow() >= 0) {
					...
					int confirmDialogResponse = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir o ve�culo '" + vehicleDescription + "'?", "Excluir ve�culo", 0);
			...
			public void actionPerformed(ActionEvent e) {
				if (vehiclesTable.getSelectedRow() >= 0) {
					...
					if (!archives.isEmpty()) {
						...
						JOptionPane.showMessageDialog(null, "O ve�culo selecionado n�o possui nenhum arquivo.");
					}
				} else {
					JOptionPane.showMessageDialog(null, "Nenhum ve�culo est� selecionado.");
				}
	...
	public void addTables() {
		...
		String[] vehicleColumns = {"ID", "TIPO", "DESCRI��O", "PLACA", "CHASSI", "RENAVAM", "COMPRADOR"};
