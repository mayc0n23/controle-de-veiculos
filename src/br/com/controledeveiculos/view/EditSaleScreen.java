...
import br.com.controledeveiculos.actions.EditSaleAction;
...
public class EditSaleScreen extends LargeView {

	private static final long serialVersionUID = 6050992912489915838L;
	...
	public EditSaleScreen(int vehicleId) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Ocorreu uma falha ao tentar encontrar o ve�culo! Tente novamente.");
	...
	public void addLabels() { 
		...
		vehicleLabel.setText("Dados do ve�culo");
		...
		descriptionLabel.setText("Descri��o");
		...
		buyerAddressLabel.setText("Endere�o *");
		...
		buyerPaymentDescriptionLabel.setText("Descri��o do pagamento *");
	...
	private void populateData() {
		...
		this.buyerNameField.setText(this.vehicle.getOutName());
		this.buyerAddressField.setText(this.vehicle.getOutAddress());
		this.buyerPhoneField.setText(this.vehicle.getOutPhone());
		this.buyerPaymentDescriptionField.setText(this.vehicle.getOutPaymentDescription());
		this.buyerCpfField.setText(this.vehicle.getOutCpf());
		this.buyerRgField.setText(this.vehicle.getOutRg());
	}
