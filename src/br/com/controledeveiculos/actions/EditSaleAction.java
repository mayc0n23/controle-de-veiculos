...
import br.com.controledeveiculos.view.EditSaleScreen;
import br.com.controledeveiculos.view.VehicleSoldListScreen;

public class EditSaleAction implements ActionListener {

private VehicleService vehicleService;
	
	private ArchiveService archiveService;
	
	private EditSaleScreen screen;
	
	private Vehicle vehicle;
	
	public EditSaleAction(EditSaleScreen screen, Vehicle vehicle) {
		this.screen = screen;
